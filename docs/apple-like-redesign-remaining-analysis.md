...
- `src/client/app.ts` уменьшен с 2001 до примерно 1107 строк, но ещё содержит несколько доменов: audio-player, reader-actions, reciter/audio data, hotkeys, home-filter.
